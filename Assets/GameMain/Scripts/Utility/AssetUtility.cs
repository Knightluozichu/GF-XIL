...
namespace StarForce
{
    ...
    {
        public static string BuildSettingsConfg;

        public static string GetDLLAsset(string assetName, bool fromBytes)
        {
            return Utility.Text.Format("Assets/GameMain/DLL/{0}.{1}", assetName, fromBytes ? "bytes" : "dll.bytes");
        }
