...
namespace wxb
{
    ...
    public static class hotMgr
    {
        ...
        public static byte[] DLL { get; set; }
        ...
        public static void Init(IResLoad resLoad = null)
        {
            ...
            {
#if UNITY_EDITOR
                ResLoad.Set(isGF? new EditorResLoadRuntime(DLL) : new EditorResLoadRuntime());
#endif
            }
            else
            {
        ...
        static public void InitHotModule()
        {
            ...
            try
            {
                DllStream = CopyStream(isGF ? ResLoad.GetStream() : ResLoad.GetStream("Data/DyncDll.dll"));
                if (DllStream != null)
                {
#if USE_PDB
