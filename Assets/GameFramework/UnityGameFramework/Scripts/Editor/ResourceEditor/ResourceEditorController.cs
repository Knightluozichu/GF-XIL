...
//            m_IncludeName = null;
        ...
        public bool Save()
        {
            try
            {
                ...
                xmlSettings.AppendChild(xmlElement);
                //xmlElement = xmlDocument.CreateElement("IncludeName");
                //xmlElement.InnerText = "HotFix_Project".ToString();
                //xmlSettings.AppendChild(xmlElement);
        ...
        public void ScanSourceAssets()
        {
            ...
            //tempGuids.UnionWith(AssetDatabase.FindAssets(IncludeName, sourceAssetSearchPaths));
